...
bool SAS = True
if SAS:
    data = pd.read_sas('../data/data.SAS7bDAT', encoding='utf-8', format=True, sep=';')
else:
...
#Cross validation pour le calibrage du modéle Random Forest
err = 0
...
print "*** accuracy_score : ", err / NBROUND
