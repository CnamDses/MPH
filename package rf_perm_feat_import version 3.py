...
=> on utilise alors le package de  rf_perm_feat_import 

https://github.com/pjh2011/rf_perm_feat_import


ATTENTION, c'était en version python 2.X et j'ai tenté de le passer en python 3.X
"""
